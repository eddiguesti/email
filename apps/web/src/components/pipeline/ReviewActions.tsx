...
import { Loader2, Sparkles, Copy, Check, Send, AlertCircle, RefreshCw, CheckCircle, XCircle, FolderOpen } from 'lucide-react';
    ...
    <div className="space-y-3">
      {reviewed ? (
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          >
            {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Sparkles className="w-4 h-4" strokeWidth={1.8} />}
